...
export class ChangesPanel {
  ...
  constructor(shadowRoot: ShadowRoot, getMarkerColor: () => string) {
    ...
    this._clearReviewedBtn.style.cssText =
      ...
      'padding:6px 14px;border-radius:8px;font-family:ImprovSans,system-ui,sans-serif;outline:none;transition:background 120ms ease,color 120ms ease,border-color 120ms ease';
  ...
  private startReply(index: number) {
    ...
    input.style.cssText =
      ...
      'font-family:ImprovSans,system-ui,sans-serif;min-width:0';
  ...
  private _showDetailContent(entry: ChangeEntry, index: number) {
    ...
    changesByFile.forEach((fileChanges, filename) => {
      ...
      fileHeader.style.cssText =
        'font-size:12px;color:rgba(255,255,255,0.5);font-family:ImprovSans,system-ui,sans-serif;' +
      ...
      chevSide.addEventListener('click', (e) => {
        ...
        for (const ed of editors) {
          ...
          row.style.cssText =
            ...
            'font-size:12px;font-family:ImprovSans,system-ui,sans-serif;outline:none;' +
      ...
      for (const c of fileChanges) {
        ...
        selectorEl.style.cssText =
          'font-size:10px;color:rgba(255,255,255,0.35);font-family:ImprovMono,ui-monospace,monospace;' +
        ...
        oldLine.style.cssText =
          'font-size:12px;font-family:ImprovMono,ui-monospace,monospace;' +
