...
export class BoxModel {
  ...
  render(computedStyles: Record<string, string>): HTMLDivElement {
    ...
    contentW.style.cssText = `font-size: 9px; color: ${CONTENT_TEXT}; font-variant-numeric: tabular-nums; font-family: "ImprovSans", system-ui, sans-serif;`;
    contentW.textContent = fmtVal(vals.width);
    this.labels.set('width', contentW);

    const contentX = document.createElement('span');
    contentX.style.cssText = `font-size: 9px; color: ${CONTENT_TEXT}; opacity: 0.5; font-family: "ImprovSans", system-ui, sans-serif;`;
    contentX.textContent = 'x';

    const contentH = document.createElement('span');
    contentH.style.cssText = `font-size: 9px; color: ${CONTENT_TEXT}; font-variant-numeric: tabular-nums; font-family: "ImprovSans", system-ui, sans-serif;`;
