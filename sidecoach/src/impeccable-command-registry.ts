...
export const IMPECCABLE_VERB_REGISTRY: Record<string, ImpeccableCommandEntry> = {
  ...
  onboard: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/onboard.md`,
    phase: 'shape',
  ...
  animate: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/animate.md`,
    phase: 'craft',
  ...
  bolder: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/bolder.md`,
    phase: 'craft',
  ...
  colorize: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/colorize.md`,
    phase: 'craft',
  ...
  delight: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/delight.md`,
    phase: 'craft',
  ...
  layout: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/layout.md`,
    phase: 'craft',
  ...
  overdrive: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/overdrive.md`,
    phase: 'craft',
  ...
  quieter: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/quieter.md`,
    phase: 'tone',
    flowIds: ['flowJ_tactical_polish'],
    guidanceAppend: [
  ...
  typeset: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/typeset.md`,
    phase: 'craft',
  ...
  clarify: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/clarify.md`,
    phase: 'craft',
  ...
  harden: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/harden.md`,
    phase: 'review',
  ...
  adapt: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/adapt.md`,
    phase: 'review',
  ...
  distill: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/distill.md`,
    phase: 'tone',
    flowIds: ['flowJ_tactical_polish'],
    guidanceAppend: [
  ...
  optimize: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/optimize.md`,
    phase: 'review',
    flowIds: ['flowJ_tactical_polish'],
    guidanceAppend: [
  ...
  extract: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/extract.md`,
    phase: 'docs',
  ...
  live: {
    ...
    impeccableSkillPath: `${IMPECCABLE_REF}/live.md`,
    phase: 'tactical',
