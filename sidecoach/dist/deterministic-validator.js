...
class DeterministicValidator {
    validate(flowId, context, history) {
        const violations = [];
        ...
        if (tier2FlowIds.includes(flowId)) {
            ...
            if (!fs.existsSync(designMdPath)) {
                ...
                const missingFrontmatterSections = [];
                ...
                try {
                    (0, child_process_1.execFileSync)('npx', ['@google/design.md', 'lint', designMdPath], {
                        timeout: 10000,
                        stdio: 'pipe',
                        cwd: projectPath,
                    });
...
//# sourceMappingURL=deterministic-validator.js.map