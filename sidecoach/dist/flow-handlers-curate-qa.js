...
exports.FlowVAllSevenQAHandler = exports.FlowUCurateHandler = void 0;
exports.registerCurateQAHandlers = registerCurateQAHandlers;
...
class FlowVAllSevenQAHandler extends flow_handler_1.BaseFlowHandler {
    ...
    async execute(context) {
        ...
        return {
            ...
            flowName: this.getFlowName(),
            status: 'success',
            message: 'All-Seven QA: Chain all 7 design pipeline tiers end-to-end (prerequisite: PRODUCT.md + DESIGN.md)',
            guidance: [
                ...guidance,
                '---',
...
function registerCurateQAHandlers() {
    return [
        ['flowU_curate', () => new FlowUCurateHandler()],
        ['flowV_all_seven_qa', () => new FlowVAllSevenQAHandler()],
    ];
}
//# sourceMappingURL=flow-handlers-curate-qa.js.map