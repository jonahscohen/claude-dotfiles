 ...
 * not generated copy).
 */
function stripNonProseSegments(input) {
    return input
...
function getContext(prose, matchStart, matchLength, contextRadius = 40) {
 ...
 * AI-template signal.
 */
function scanRhetoricalPatterns(prose) {
    const patterns = (0, reference_loader_1.loadRhetoricalPatterns)();
    const findings = [];
 ...
 */
function scanForLinguisticBans(input, label) {
 ...
 */
function findingsToGuidance(report) {
...
//# sourceMappingURL=linguistic-ban-validator.js.map