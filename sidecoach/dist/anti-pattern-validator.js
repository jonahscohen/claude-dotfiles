...
class AntiPatternValidator {
    ...
    validateCode(code) {
        ...
        for (const [key, pattern] of Object.entries(design_laws_1.ANTI_PATTERNS)) {
    ...
    getSuggestedFix(patternName) {
        const fixes = {
            ...
            'Glassmorphism as default': 'Reserve glassmorphism for overlay/modal contexts only',
