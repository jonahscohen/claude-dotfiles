...
const test1 = (0, slash_command_router_1.parseSlashCommand)('/sidecoach research Button');
...
const test2 = (0, slash_command_router_1.parseSlashCommand)('/sidecoach implement Page');
...
const test3 = (0, slash_command_router_1.parseSlashCommand)('/review Button');
...
const test4 = (0, slash_command_router_1.parseSlashCommand)('/clone Modal');
...
const test5 = (0, slash_command_router_1.parseSlashCommand)('/constrain Modal from design');
...
const test6 = (0, slash_command_router_1.parseSlashCommand)('/migrate');
...
const test7 = (0, slash_command_router_1.parseSlashCommand)('/refactor');
...
const test8 = (0, slash_command_router_1.parseSlashCommand)('/type');
console.log('\n[Test 8] Parse "/type"');
...
const test9 = (0, slash_command_router_1.parseSlashCommand)('/motion');
console.log('\n[Test 9] Parse "/motion"');
...
const test10 = (0, slash_command_router_1.parseSlashCommand)('/reference');
...
const test11 = (0, slash_command_router_1.parseSlashCommand)('/comprehensive');
...
const test12 = (0, slash_command_router_1.parseSlashCommand)('/list');
console.log('\n[Test 12] Parse "/list"');
...
const test13 = (0, slash_command_router_1.parseSlashCommand)('/unknown');
...
const test14 = (0, slash_command_router_1.parseSlashCommand)('make a button');
...
const hasAllCommands = expectedCommands.every(cmd => commands[cmd]);
...
//# sourceMappingURL=slash-command.test.js.map