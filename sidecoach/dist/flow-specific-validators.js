...
exports.FlowSpecificValidator = void 0;
exports.getFlowValidatorConfig = getFlowValidatorConfig;
// ===== Flow A: Brand Verify Validator =====
const brandVerifyRules = [
    {
...
class FlowSpecificValidator {
    static getValidatorConfig(flowId) {
        return FLOW_VALIDATORS[flowId];
    }
    static validateFlow(flowId, context, result) {
    ...
    static validateAll(flowId, context, result) {
        const results = {};
...
exports.FlowSpecificValidator = FlowSpecificValidator;
function getFlowValidatorConfig(flowId) {
    return FlowSpecificValidator.getValidatorConfig(flowId);
}
//# sourceMappingURL=flow-specific-validators.js.map