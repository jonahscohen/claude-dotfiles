...
exports.SidecoachCommand = void 0;
exports.createSidecoachCommand = createSidecoachCommand;
const sidecoach_orchestrator_1 = require("./sidecoach-orchestrator");
// Command to flow mapping
const COMMAND_FLOW_MAP = {
...
class SidecoachCommand {
    constructor() {
        this.engine = new sidecoach_orchestrator_1.FlowExecutionEngine();
    }
...
exports.SidecoachCommand = SidecoachCommand;
// Export factory for use in skill
function createSidecoachCommand() {
    return new SidecoachCommand();
}
//# sourceMappingURL=sidecoach-command.js.map