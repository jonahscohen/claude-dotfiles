import type { JustifyAdapter, AdapterEnrichment } from '../types';

declare global {
  interface Window {
    __justify?: { registerAdapter(adapter: JustifyAdapter): void };
  }
}
...
const svelteAdapter: JustifyAdapter = {
  name: 'svelte',
...
if (typeof window !== 'undefined' && window.__justify) {
  window.__justify.registerAdapter(svelteAdapter);
}
