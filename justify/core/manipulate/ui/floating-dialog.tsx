/**
 * FloatingDialog - shared base for floating panels (color picker, etc.)
 * Anchor-based positioning with collision detection, header (title or tabs +
 * close), optional search, scrollable body, close-on-escape, close-on-outside-
 * click, scroll lock. Native DOM listeners for close (Shadow DOM safe).
 *
 * Ported near-verbatim from Retune overlay/src/ui/floating-dialog.tsx.
 */
