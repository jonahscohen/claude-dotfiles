/**
 * DropdownMenu - Figma-style dark dropdown menu (always-dark #1c1917 bg).
 * Features: checkmark for selected, keyboard highlight, scroll overflow
 * indicators with smooth rAF scrolling, separators + headings, hover preview.
 *
 * Ported verbatim from Retune overlay/src/ui/dropdown-menu.tsx.
 */
