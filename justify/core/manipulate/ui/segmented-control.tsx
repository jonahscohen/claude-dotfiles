/**
 * SegmentedControl - icon-based toggle group with an iOS-style sliding pill.
 * Plain CSS, no Tailwind/Radix.
 *
 * Ported verbatim from Retune overlay/src/ui/segmented-control.tsx.
 */
