 ...
 *
 * Ported verbatim-in-behavior from Retune (overlay/src/ui/gradient-utils.ts).
 * Pure logic - no DOM. gradientToCss is the EXACT string the FillSection emits
 * to backgroundImage. (Comments de-emdashed for the content guard.)
 */

import { hexToRgb, rgbToHex, parseCssColor, hexToRgba } from "./color-utils.js";
