 ...
 *
 * Ported verbatim (behavior + values) from Retune (overlay/src/ui/shadow-utils.ts).
 * Pure logic - no DOM. parseBoxShadow edits the FIRST LAYER ONLY (per plan k).
 * (Comments de-emdashed for the content guard.)
 */
